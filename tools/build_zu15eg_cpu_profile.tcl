# Build the focused CPU + AXI + PMU + JTAG/debug profile for ZU15EG.
if {$argc != 4} {
    error "usage: build_zu15eg_cpu_profile.tcl <repo-root> <out-dir> <jobs> <cpu-clock-div>"
}
...
set top_name zu15eg_cpu_profile_top
...
lappend rtl_files \
    ...
    [file join $repo_root fpga zu15eg_cpu_profile_top.v]
...
puts "ZU15EG_CPU_PROFILE_BUILD=PASS"
puts "ZU15EG_CPU_PROFILE_CLOCK_DIV=$cpu_clock_div"
