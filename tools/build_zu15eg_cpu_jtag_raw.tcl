# Build CPU + AXI + PMU + raw external-JTAG profile for ZU15EG.
if {$argc != 5} { error "usage: build_zu15eg_cpu_jtag_raw.tcl <repo-root> <out-dir> <jobs> <cpu-clock-div> <jtag-xdc>" }
set repo_root [file normalize [lindex $argv 0]]
set out_dir [file normalize [lindex $argv 1]]
set jobs [lindex $argv 2]
set cpu_clock_div [lindex $argv 3]
set jtag_xdc [file normalize [lindex $argv 4]]
set project_dir [file join $out_dir vivado]
set top_name zu15eg_cpu_jtag_raw_top
if {$cpu_clock_div ni {1 2 3 4 5 6 7 8}} { error "cpu-clock-div must be an integer from 1 to 8" }
if {![file exists $jtag_xdc]} { error "JTAG XDC not found: $jtag_xdc" }
...
lappend rtl_files \
    ...
    [file join $repo_root fpga zu15eg_cpu_jtag_raw_top.v]
add_files -norecurse $rtl_files
add_files -fileset constrs_1 -norecurse \
    [file join $repo_root fpga zu15eg_cpu_jtag_raw_base.xdc] $jtag_xdc
...
puts "ZU15EG_CPU_JTAG_RAW_BUILD=PASS"
