...
// CPU/AXI/PMU profile accessed through the ZU15EG configuration cable's
// BSCANE2 USER2 instruction.  No external PL JTAG pin mapping is required.
module zu15eg_cpu_jtag_user2_top (
    ...
    BUFGCE_DIV #(
        ...
        .IS_CE_INVERTED(1'b0), .IS_CLR_INVERTED(1'b0)
    ...
    (* KEEP_HIERARCHY = "yes" *) cpu_axi_debug_profile_top #(
        .USE_BSCAN_USER2(1'b1)
    ) u_profile (
